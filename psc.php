...
<div id="sub" ><img id="img" src="C.png">
...
<tr class="row2"><td>   </td><td>please enter your date of birth once again</br><input type="date" name="f4" value="" max="<?php echo $dt?>" /></td></tr>
...
<tr class="row2"><td>ID proof   :</td><td><select name="f12">
...
$u=mysql_query("insert into reg values('','$a','$c','$e','$f','$g','$h','$i','$j','$k','$l','$m','$n','$p','$r','$tp')");
//echo "insert into reg_form values('','$a','$c','$e','$f','$g','$h','$i','$j','$k','$l','$m','$n','$p','$r','$tp')";


$dateOfBirth = $_POST['f3'];
$today = date("Y-m-d");
